...
import { ProjectionVision } from '@/components/profit/ProjectionVision';
import { AdjustTradeDialog } from '@/components/profit/AdjustTradeDialog';
  ...
  return (
    <div className="space-y-6">
      ...
      <ProjectionVision
        ...
        setProjectionView={setProjectionView}
        projectionChartData={projectionChartData}
        projectionData={projectionData}
        effectiveAccountValue={effectiveAccountValue}
        effectiveLotSize={effectiveLotSize}
        effectiveTotalProfit={effectiveTotalProfit}
        isLicensee={isLicensee}
        selectedYears={selectedYears}
        setSelectedYears={setSelectedYears}
        yearlyGroupedProjection={yearlyGroupedProjection}
        handleOpenDailyProjection={handleOpenDailyProjection}
        formatLargeNumber={formatLargeNumber}
        formatMoney={formatMoney}
        truncateTo2Decimals={truncateTo2Decimals}
        dataHealth={dataHealth}
        openBalanceVerification={openBalanceVerification}
        displayAccountValue={displayAccountValue}
        simulatedView={simulatedView}
        DataHealthBadge={DataHealthBadge}
      />
      ...
      <AdjustTradeDialog
        open={enterAPDialogOpen}
        onOpenChange={setEnterAPDialogOpen}
        isMobile={isMobile}
        enterAPDate={enterAPDate}
        adjustmentType={adjustmentType}
        setAdjustmentType={setAdjustmentType}
        adjustmentAmount={adjustmentAmount}
        setAdjustmentAmount={setAdjustmentAmount}
        adjustedBalance={adjustedBalance}
        setAdjustedBalance={setAdjustedBalance}
        enterAPValue={enterAPValue}
        setEnterAPValue={setEnterAPValue}
        enterAPCommission={enterAPCommission}
        setEnterAPCommission={setEnterAPCommission}
        enterAPLoading={enterAPLoading}
        handleSubmitEnterAP={handleSubmitEnterAP}
        formatLargeNumber={formatLargeNumber}
        formatMoney={formatMoney}
        truncateTo2Decimals={truncateTo2Decimals}
      />
