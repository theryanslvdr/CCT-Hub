...
import { settingsAPI, adminAPI, adminHabitAPI, adminAffiliateAPI } from '@/lib/api';
        ...
        {showForm && (
          <div className="p-4 rounded-lg bg-zinc-900/60 border border-teal-500/30 space-y-3" data-testid="habit-form">
            <Input
              ...
              placeholder="Habit title (e.g., Send 1 invite today)"
            ...
            {form.action_type !== 'generic' && (
              <Textarea
                ...
                onChange={(e) => setForm(p => ({ ...p, action_data: e.target.value }))}
                placeholder={form.action_type === 'send_invite' ? 'Pre-written invite message...' : 'URL to visit...'}
                className="input-dark"
                rows={3}
                data-testid="habit-action-data"
              />
            )}
          ...
          {showForm && (
            <div className="p-4 rounded-lg bg-zinc-900/60 border border-cyan-500/30 space-y-3" data-testid="resource-form">
              ...
              <Textarea
                ...
                placeholder="Resource content (members can copy this)"
                className="input-dark"
                rows={4}
        ...
        <CardContent className="space-y-4">
          ...
          {chatbase.enabled && (
            <div>
              ...
              <Input
                value={chatbase.bot_id}
                onChange={(e) => setChatbase(p => ({ ...p, bot_id: e.target.value }))}
                placeholder="e.g., abc123-def456-..."
                className="input-dark mt-1"
                data-testid="chatbase-bot-id"
              />
            </div>
          )}
