...
# Member routes moved to admin_members_routes.py
# ─── Signals History ───
...
async def create_license_invite(data: LicenseInviteCreate, user: dict = Depends(deps.require_admin)):
    ...
    frontend_url = os.environ.get("FRONTEND_URL", "https://ui-mobile-overhaul-3.preview.emergentagent.com")
...
# Registration and cleanup routes moved to admin_cleanup_routes.py
