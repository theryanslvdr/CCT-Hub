...
@admin_habit_router.post("/habits")
...
@admin_habit_router.put("/habits/{habit_id}")
...
@admin_habit_router.delete("/habits/{habit_id}")
...
@admin_habit_router.post("/habits/{habit_id}/activate")
