...
# Push notification helpers extracted to helpers.py
from helpers import send_push_notification, send_push_to_all_members, send_push_to_admins
...
async def create_license_invite(data: LicenseInviteCreate, user: dict = Depends(require_admin)):
    ...
    frontend_url = os.environ.get("FRONTEND_URL", "https://licensee-profit-fix.preview.emergentagent.com")
